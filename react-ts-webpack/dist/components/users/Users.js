...
var Users = /** @class */ (function (_super) {
    ...
    Users.prototype.getAllUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var endpoint, initialResponse, jsonResponse;
    ...
    Users.prototype.listUsers = function () {
        React.createElement("ul", null, this.state.users.map(function (user) {
            React.createElement("li", null, user.name);
        }));
    };
    Users.prototype.render = function () {
        return (React.createElement("div", null, this.listUsers));
    };
    return Users;
}(React.Component));
exports.Users = Users;
